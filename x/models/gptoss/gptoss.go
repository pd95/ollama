...
func (m *Model) Forward(_ *batch.Batch, _ []cache.Cache) (*mlx.Array, *mlx.Array) {
	return nil, nil
}
...
// NewCaches declares the alternating sliding-window and full-attention cache
// slots owned by GPT-OSS.
